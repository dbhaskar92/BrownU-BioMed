...
% Complete Sorting: [0.23 0.05; 0.05 0.23]
% Engulfment: [0.25 0.17; 0.17 0.21] ? (not tested)
% Lipid Bilayer: [0.05 0.23; 0.23 0.05]
% Two Phase: [0.05 0.05; 0.05 0.23] (individual + clusters)

cond_str = "DAH_Bilayer";
mkdir(char(cond_str));
...
polarity_strength = 0.0130;                                 % Random polarization force   
adhesion_strength = [0.05 0.23; 0.23 0.05];                 % Cell-Cell adhesion matrix
